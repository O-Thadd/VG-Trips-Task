...
val trip1 = UiTrip(
    ...
    duration = "7 days",
    ordinalStateDate = "11th September 2024",
...
val trip2 = UiTrip(
    ...
    duration = "2 days",
    ordinalStateDate = "30th September 2024",
    activities = emptyList(),
    flights = emptyList(),
    hotels = emptyList()
)
...
val trip3 = UiTrip(
    ...
    duration = "19 days",
    ordinalStateDate = "1st October 2024",
    activities = emptyList(),
    flights = emptyList(),
    hotels = emptyList()
)

val homeUiState = HomeUiState(listOf(trip1, trip2, trip3))